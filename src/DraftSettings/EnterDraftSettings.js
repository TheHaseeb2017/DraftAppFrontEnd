...
const DraftSettings = () => {
  ...
  async function updateDraft() {
    ...
    try {
      const responce = await fetch(
        `https://1vzae36dp1.execute-api.us-east-1.amazonaws.com/dev/draftsetting/update/${draftCode}`,
        options
      );
      console.log(responce); // Log the response
      const data = await responce.json();
  ...
  async function getPlayersWithTeam() {
    ...
    try {
      const responce = await fetch(
        `https://1vzae36dp1.execute-api.us-east-1.amazonaws.com/dev/drafts/playerwithteam/${draftCode}`,
        options
      );
      console.log(responce); // Log the response
      const data = await responce.json();
  ...
  async function deletePlayer(playerids) {
    ...
    try {
      ...
      const responce = await fetch(
        `https://1vzae36dp1.execute-api.us-east-1.amazonaws.com/dev/delete-players`,
        options
      );
